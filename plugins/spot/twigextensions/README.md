...
[![Build Status](https://travis-ci.org/spot/oc-twigextensions-plugin.svg?branch=master)](https://travis-ci.org/spot/oc-twigextensions-plugin)
[![Codacy](https://img.shields.io/codacy/c6b23b6527bd407092763cace324ef4a.svg)](https://www.codacy.com/app/spot/oc-twigextensions-plugin)
[![Scrutinizer Coverage](https://img.shields.io/scrutinizer/g/spot/oc-twigextensions-plugin.svg)](https://scrutinizer-ci.com/g/spot/oc-twigextensions-plugin/?branch=master)
[![License](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/spot/oc-twigextensions-plugin/blob/master/LICENSE)
...
```
composer require spot/oc-twigextensions-plugin:dev-master
```
...
```
<a href="mailto:spot.cz@gmail.com">spot.cz@gmail.com</a>
```
...
```
{{ 'spot.cz@gmail.com' | mailto(true, true, 'Let me know', 'my-class') }}
```
...
See: https://github.com/spot/oc-twigextensions-plugin/issues/25  
...
- [ ] Add [cache extension](https://github.com/spot/oc-twigextensions-plugin/issues/11).
